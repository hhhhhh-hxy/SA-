    ...
    <div class="flex-row justify-between items-center group">
      <div class="flex-row items-center">
        <img
          ...
          src="https://ide.code.fun/api/image?token=6657d013a16e9e0012508def&name=0a922eefb13d518e76b860dcf37bda20.png"
        />
        <span class="font text ml-21">学习平台</span>
      </div>
      <div class="flex-row items-center group_2">
        <span class="font_2 text_2 text_3">教师主页</span>
        <span class="font_2 text_2 text_4">批改作业</span>
        <div class="flex-row items-center shrink-0 group_3">
          <span class="font text_5">课程名称{{}}</span>
          <div class="flex-row items-center shrink-0 ml-59">
            <span class="font text_6">教师id：{{}}</span>
        ...
        <table>
          ...
          <tbody>
            <tr v-for="(homework, index) in homeworks" :key="index">
              ...
              <td><span class="font_2 text_2">查看详情</span></td>
              <div class="shrink-0 divider mt-79"></div>
            </tr>
          </tbody>
        </table>
